  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        "hover:bg-sidebar-accent hover:text-sidebar-accent-foreground data-[active=true]:hover:bg-sidebar-accent data-[active=true]:hover:text-sidebar-accent-foreground",
